...
void RawImage::copy_from_yuyv(const string& src)
{
...
void RawImage::copy_y_from(const string& src)
{
  if (src.size() != y_size()) {
...
void RawImage::copy_u_from(const string& src)
{
  if (src.size() != uv_size()) {
...
void RawImage::copy_v_from(const string& src)
{
  if (src.size() != uv_size()) {
